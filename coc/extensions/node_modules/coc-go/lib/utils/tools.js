...
exports.formatCmd = exports.execTool = exports.commandExists = exports.runGoTool = exports.goBinPath = exports.installGoBin = void 0;
...
////////////////////////////////////////////////////////////////////////////////
function formatCmd(env, cmd) {
    const keys = Object.keys(env);
    if (keys.length > 0) {
        const isWin = os_1.default.platform() === 'win32';
        const tpl = isWin ? `set %s=%s &` : `%s=%s`;
        const pre = isWin ? `` : `env `;
        const setEnv = keys.map(k => util_1.format(tpl, k, env[k])).join(' ');
